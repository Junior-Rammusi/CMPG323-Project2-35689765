...
using Project2_35689765.Models;

namespace Project2_35689765.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class OrderDetailsController : ControllerBase
    {
        private readonly EcoPowerLogisticsContext _context;

        public OrderDetailsController(EcoPowerLogisticsContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<OrderDetail>> PostOrderDetail(OrderDetail orderDetail)
        {
          if (_context.OrderDetails == null)
          {
              return Problem("Entity set 'EcoPowerLogisticsContext.OrderDetails'  is null.");
          }
